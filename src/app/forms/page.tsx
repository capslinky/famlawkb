...
const formCategories: FormCategory[] = [
  {
    ...
    forms: [
      {
        name: 'Petition for Dissolution (Divorce) - With Children',
        description: 'Start a divorce case when you have minor children',
        formNumber: 'DR11',
        slug: 'divorce-petition-children',
      },
      {
        name: 'Petition for Dissolution (Divorce) - No Children',
        description: 'Start a divorce case without minor children',
        formNumber: 'DR12',
  ...
  },
  {
    ...
    description: 'Forms for custody, visitation, and parenting time',
    forms: [
      {
        name: 'Petition to Establish Custody',
        description: 'Request custody orders for unmarried parents',
        formNumber: 'DR21',
        slug: 'petition-establish-custody',
      },
      {
        name: 'Parenting Plan',
        description: 'Detailed custody and visitation schedule',
        formNumber: 'DR22',
        slug: 'parenting-plan',
      },
      {
        name: 'Petition to Modify Custody',
        description: 'Request changes to existing custody orders',
        formNumber: 'DR23',
        slug: 'petition-modify-custody',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    forms: [
      ...
      {
        name: 'Petition for Injunction Against Harassment',
        description: 'Stop harassment from non-family members',
        formNumber: 'IAH1',
        slug: 'injunction-harassment',
      },
    ],
  },
  {
    title: 'Response Forms',
    description: 'Forms for responding to court papers',
    forms: [
      {
        name: 'Response to Petition',
        description: 'General response to family court petitions',
        formNumber: 'DR40',
        slug: 'response-petition',
      },
      {
        name: 'Response to Motion',
        description: 'Respond to motions filed by other party',
        formNumber: 'DR41',
        slug: 'response-motion',
      },
      {
        name: 'Motion to Set Aside Default',
        description: 'Request to undo default judgment',
        formNumber: 'DR42',
        slug: 'motion-set-aside-default',
      },
    ],
  },
  {
    ...
    forms: [
      ...
      {
        name: 'Notice of Relocation',
        description: 'Notify of intent to move with children',
        formNumber: 'DR52',
        slug: 'relocation-notice',
      },
      {
        name: 'Emergency Motion',
        description: 'Request urgent court action',
        formNumber: 'DR53',
